Kör GameHub.py för att starta programmet.

Chas Academy - Systemutveckling i Python uppgift 1.

Använd kunskaper om grundläggande python för att göra små spel.
